...
export function normalizeDescriptionHtml(input: string) {
...
export function sanitizePropertyDescription(input: string) {
  const normalized = normalizeDescriptionHtml(input);
